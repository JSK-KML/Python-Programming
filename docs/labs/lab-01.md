...
## Cloning Your Reposity

Now that you have done forking, the code is fully yours, but it only exist in Github web server. This is great, however, editing the code online, although feasible, is not a very smooth experience. 

To solve this, we need to clone the repository into your computer so you can edit and run the code using your IDE, which in this class we have choose VS Code.
