...
🐍 Using Skulpt Python interpreter.`,n("Python execution error")}}window.switchLanguage=m,window.runCode=g,window.downloadCode=u,window.openFullscreenTab=b,window.openMobileTab=S,window.clearOutput=k,window.resetCode=P,document.readyState==="loading"?document.addEventListener("DOMContentLoaded",y):y();const h=document.createElement("style");h.textContent=`
  ...
  `,document.head.appendChild(h)}const L=JSON.parse('{"title":"Python Editor","description":"Interactive Python code editor with real-time execution","frontmatter":{"outline":"deep","title":"Python Editor","description":"Interactive Python code editor with real-time execution"},"headers":[],"relativePath":"editor/python-editor.md","filePath":"editor/python-editor.md"}'),I={name:"editor/python-editor.md"},M={id:"python-editor",tabindex:"-1"};function z(s,a,d,c,p,m){const u=x("Badge");return T(),v("div",null,[i("h1",M,[a[0]||(a[0]=f("Python Editor ")),O(u,{type:"danger",text:"Experimental"}),a[1]||(a[1]=f()),a[2]||(a[2]=i("a",{class:"header-anchor",href:"#python-editor","aria-label":'Permalink to "Python Editor <Badge type="danger" text="Experimental" />"'},"​",-1))]),a[3]||(a[3]=i("p",null,"An interactive Python code editor that runs real Python code in your browser",-1)),a[4]||(a[4]=i("div",{class:"editor-container"},[i("div",{class:"tabs"},[i("button",{class:"tab active",onclick:"switchLanguage('python')"},"Python")]),i("div",{class:"editor-wrapper"},[i("div",{id:"monaco-editor"})]),i("div",{class:"buttons"},[i("button",{class:"run",onclick:"runCode()"},"Run Code"),i("button",{class:"download",onclick:"downloadCode()"},"Download"),i("button",{class:"fullscreen",onclick:"openFullscreenTab()"},"Open in Full Screen"),i("button",{class:"fullscreen",onclick:"openMobileTab()"},"Mobile Editor"),i("button",{class:"clear",onclick:"clearOutput()"},"Clear Output"),i("button",{class:"reset",onclick:"resetCode()"},"Reset Code")]),i("div",{class:"result"},[i("strong",null,"Output:"),i("div",{id:"output"},'Write some Python code and click "Run Code" to see results...')])],-1)),a[5]||(a[5]=_("",5))])}const N=E(I,[["render",z]]);export{L as __pageData,N as default};
