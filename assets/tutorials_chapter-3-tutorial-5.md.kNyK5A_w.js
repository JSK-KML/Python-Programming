import{_ as l,C as i,o,c as r,j as s,a,G as p,a3 as t}from"./chunks/framework.COxCSqPW.js";const d="/Python-Programming/assets/c3t5-1.C5cSRf7U.png",R=JSON.parse('{"title":"Tutorial 5 : Chapter 3","description":"","frontmatter":{"title":"Tutorial 5 : Chapter 3","outline":"deep"},"headers":[],"relativePath":"tutorials/chapter-3-tutorial-5.md","filePath":"tutorials/chapter-3-tutorial-5.md"}'),u={name:"tutorials/chapter-3-tutorial-5.md"},c={id:"pseudocode-indentation-rules",tabindex:"-1"},g={id:"exercise-1",tabindex:"-1"},h={id:"exercise-2",tabindex:"-1"},I={id:"exercise-3",tabindex:"-1"},b={id:"exercise-4",tabindex:"-1"},E={id:"exercise-5",tabindex:"-1"};function v(T,n,N,q,m,P){const e=i("Badge");return o(),r("div",null,[n[18]||(n[18]=s("h1",{id:"tutorial-5-chapter-3",tabindex:"-1"},[a("Tutorial 5 : Chapter 3 "),s("a",{class:"header-anchor",href:"#tutorial-5-chapter-3","aria-label":'Permalink to "Tutorial 5 : Chapter 3"'},"​")],-1)),s("h2",c,[n[0]||(n[0]=a("Pseudocode Indentation Rules ",-1)),p(e,{type:"warning",text:"Recall"}),n[1]||(n[1]=a()),n[2]||(n[2]=s("a",{class:"header-anchor",href:"#pseudocode-indentation-rules","aria-label":'Permalink to "Pseudocode Indentation Rules <Badge type="warning" text="Recall" />"'},"​",-1))]),n[19]||(n[19]=t(`<h3 id="if-statement-indentation-rules" tabindex="-1">IF Statement Indentation Rules <a class="header-anchor" href="#if-statement-indentation-rules" aria-label="Permalink to &quot;IF Statement Indentation Rules&quot;">​</a></h3><p><strong>Rule 1: ALL statements inside an IF block MUST be indented</strong></p><p><strong>CORRECT - Statements inside IF are indented:</strong></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>BEGIN</span></span>
