...
<span class="line"><span>END                            ← Level 0 (Closes BEGIN)</span></span></code></pre></div>`,13)),s("h2",b,[n[9]||(n[9]=a("Exercise 1 ",-1)),t(e,{type:"tip",text:"Task"}),n[10]||(n[10]=a()),n[11]||(n[11]=s("a",{class:"header-anchor",href:"#exercise-1","aria-label":'Permalink to "Exercise 1 <Badge type="tip" text="Task" />"'},"​",-1))]),n[28]||(n[28]=p(`<p>Convert the below pseudocode into a flowchart and IPO table.</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>Start</span></span>
...
<span class="line"><span>Stop</span></span></code></pre></div>`,2)),s("h2",T,[n[12]||(n[12]=a("Exercise 2 ",-1)),t(e,{type:"tip",text:"Task"}),n[13]||(n[13]=a()),n[14]||(n[14]=s("a",{class:"header-anchor",href:"#exercise-2","aria-label":'Permalink to "Exercise 2 <Badge type="tip" text="Task" />"'},"​",-1))]),n[29]||(n[29]=p('<p>Convert the below IPO table into a flowchart and pseudocode.</p><table tabindex="0"><thead><tr><th><strong>INPUT</strong></th><th><strong>PROCESS</strong></th><th><strong>OUTPUT</strong></th></tr></thead><tbody><tr><td>workout_minutes for 5 days</td><td>repeat determine daily_points based on workout_minutes for 5 times</td><td>total_points</td></tr><tr><td></td><td>repeat calculate total_points based on daily_points for 5 times</td><td></td></tr></tbody></table>',2)),s("h2",E,[n[15]||(n[15]=a("Exercise 3 ",-1)),t(e,{type:"tip",text:"Task"}),n[16]||(n[16]=a()),n[17]||(n[17]=s("a",{class:"header-anchor",href:"#exercise-3","aria-label":'Permalink to "Exercise 3 <Badge type="tip" text="Task" />"'},"​",-1))]),n[30]||(n[30]=s("p",null,"Convert the below flowchart into an IPO table and pseudocode.",-1)),n[31]||(n[31]=s("p",{align:"center"},[s("img",{src:d,alt:"drawing",width:"300"})],-1)),s("h2",I,[n[18]||(n[18]=a("Exercise 4 ",-1)),t(e,{type:"tip",text:"Task"}),n[19]||(n[19]=a()),n[20]||(n[20]=s("a",{class:"header-anchor",href:"#exercise-4","aria-label":'Permalink to "Exercise 4 <Badge type="tip" text="Task" />"'},"​",-1))]),n[32]||(n[32]=p(`<p>Convert the following pseudocode into a flowchart and IPO</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>Start</span></span>
